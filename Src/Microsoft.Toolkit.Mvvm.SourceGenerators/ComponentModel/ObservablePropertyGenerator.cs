...
namespace Microsoft.Toolkit.Mvvm.SourceGenerators
{
    ...
    {
        public static class SymbolEqualityComparer 
        {
            internal static class Default
            {
                internal static bool Equals(object attributeClass, INamedTypeSymbol attributeSymbol)
                {
        ...
        public void Initialize(GeneratorInitializationContext context)
        {
            context.RegisterForSyntaxNotifications(static () 
                => new Microsoft.Toolkit.Mvvm.SourceGenerators.SyntaxReceiver());
        }
        ...
        {
            INamedTypeSymbol
                iNotifyPropertyChangingSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.ComponentModel.INotifyPropertyChanging")!,
                observableObjectSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.ComponentModel.ObservableObject")!,
                observableObjectAttributeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.ComponentModel.ObservableObjectAttribute")!,
                observableValidatorSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.ComponentModel.ObservableValidator")!;
            ...
            bool
                ...
                isNotifyPropertyChanging =
                    isObservableObject ||
                    classDeclarationSymbol.AllInterfaces.Contains(iNotifyPropertyChangingSymbol) ||
        ...
        private static PropertyDeclarationSyntax CreatePropertyDeclaration(GeneratorExecutionContext context, object leadingTrivia, object fieldSymbol, bool isNotifyPropertyChanging, bool isObservableValidator, ICollection<string> propertyChangedNames, ICollection<string> propertyChangingNames)
        {
            throw new System.NotImplementedException();
        }
            ...
            ICollection<string> propertyChangingNames)
        {
            ...
            INamedTypeSymbol alsoNotifyChangeForAttributeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.ComponentModel.AlsoNotifyChangeForAttribute")!;
            INamedTypeSymbol? validationAttributeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.ComponentModel.DataAnnotations.ValidationAttribute");
            ...
            if (fieldSymbol.Type != null)// is { IsReferenceType: true, NullableAnnotation: NullableAnnotation.Annotated })
            {
                ...
                .AddAttributeLists(
                    AttributeList(SingletonSeparatedList(
                        ...
                        .AddArgumentListArguments(
                            ...
                            AttributeArgument(LiteralExpression(SyntaxKind.StringLiteralExpression, Literal(typeof(ObservablePropertyGenerator).FullName.ToString())))))),
        ...
        public void OnExecuteForPropertyArgs(GeneratorExecutionContext context, IReadOnlyCollection<string> propertyChangedNames, IReadOnlyCollection<string> propertyChangingNames)
        {
            ...
            INamedTypeSymbol
                propertyChangedEventArgsSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.ComponentModel.PropertyChangedEventArgs")!,
                propertyChangingEventArgsSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.ComponentModel.PropertyChangingEventArgs")!;
                    ...
                    Token(SyntaxKind.StaticKeyword)).AddAttributeLists(
                        AttributeList(SingletonSeparatedList(
                            ...
                            .AddArgumentListArguments(
                                ...
                                AttributeArgument(LiteralExpression(SyntaxKind.StringLiteralExpression, Literal(GetType().FullName.ToString())))))),
                        AttributeList(SingletonSeparatedList(Attribute(IdentifierName("global::System.Diagnostics.DebuggerNonUserCode")))),
                        AttributeList(SingletonSeparatedList(Attribute(IdentifierName("global::System.Diagnostics.CodeAnalysis")))), // .ExcludeFromCodeCoverage
                        AttributeList(SingletonSeparatedList(
        ...
        private static object ImplicitObjectCreationExpression()
        {
            //throw new System.NotImplementedException();
            return null;
        }
    ...
    {
        public static object GatheredInfo { get; internal set; }
    }
}
