...
namespace Microsoft.Toolkit.Mvvm.SourceGenerators
{
    ...
    public sealed partial class ObservableValidatorValidateAllPropertiesGenerator : ISourceGenerator
    {
        ...
        public void Initialize(GeneratorInitializationContext context)
        {
           ...
           {
               return new Microsoft.Toolkit.Mvvm.SourceGenerators.SyntaxReceiver();
           });
        }
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            if (context.ParseOptions is not CSharpParseOptions { LanguageVersion: >= LanguageVersion.CSharp7_3 })
            {
            ...
            INamedTypeSymbol
                validationSymbol = null!,//context.Compilation.GetTypeByMetadataName("System.ComponentModel.DataAnnotations.ValidationAttribute")!,
                observablePropertySymbol = null!;//context.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.ComponentModel.ObservablePropertyAttribute")!;
        ...
        private static IEnumerable<StatementSyntax> EnumerateValidationStatements(INamedTypeSymbol classSymbol, INamedTypeSymbol validationSymbol, INamedTypeSymbol observablePropertySymbol)
        {
            foreach (var memberSymbol in classSymbol.GetMembers())
            {
                ...
                if (memberSymbol is IFieldSymbol &&
                    !attributes.Any(a => SymbolEqualityComparer.Equals(a.AttributeClass, observablePropertySymbol)))
                {
                    continue;
                }
