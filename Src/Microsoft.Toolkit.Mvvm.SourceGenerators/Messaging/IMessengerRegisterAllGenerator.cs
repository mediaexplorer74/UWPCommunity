...
namespace Microsoft.Toolkit.Mvvm.SourceGenerators
{
    ...
    public sealed partial class IMessengerRegisterAllGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            INamedTypeSymbol iRecipientSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Messaging.IRecipient`1")!;
        ...
        private SyntaxToken Literal(object p)
        {
