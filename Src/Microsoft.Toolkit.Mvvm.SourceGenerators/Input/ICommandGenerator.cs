...
namespace Microsoft.Toolkit.Mvvm.SourceGenerators
{
    ...
    public sealed partial class ICommandGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            if (context.ParseOptions is not CSharpParseOptions { LanguageVersion: >= LanguageVersion.CSharp7_1 })
            {
            ...
            FieldDeclarationSyntax fieldDeclaration =
                ...
                .AddAttributeLists(AttributeList(SingletonSeparatedList(
                    ...
                    .AddArgumentListArguments(
                        ...
                        AttributeArgument(LiteralExpression(SyntaxKind.StringLiteralExpression, Literal(typeof(ICommandGenerator).FullName.ToString() )))))));
        ...
        private static (string FieldName, string PropertyName) GetGeneratedFieldAndPropertyNames(GeneratorExecutionContext context, IMethodSymbol methodSymbol)
        {
            ...
            if (SymbolEqualityComparer.Default.Equals(methodSymbol.ReturnType, GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Threading.Tasks.Task")) &&
            ...
            [NotNullWhen(true)] out ITypeSymbol? delegateTypeSymbol)
        {
            ...
            {
                commandInterfaceTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.IRelayCommand")!;
                commandClassTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.RelayCommand")!;
                delegateTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Action")!;
            ...
            if (methodSymbol.ReturnsVoid &&
                ...
                methodSymbol.Parameters[0] is IParameterSymbol { RefKind: RefKind.None, Type: { BaseType: null, TypeKind: not TypeKind.Pointer and not TypeKind.Pointer } } parameter)
            {
                commandInterfaceTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.IRelayCommand`1")!.Construct(parameter.Type);
                commandClassTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.RelayCommand`1")!.Construct(parameter.Type);
                delegateTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Action`1")!.Construct(parameter.Type);
            ...
            if (SymbolEqualityComparer.Default.Equals(methodSymbol.ReturnType, GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Threading.Tasks.Task")!))
            {
                ...
                {
                    commandInterfaceTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.IAsyncRelayCommand")!;
                    commandClassTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.AsyncRelayCommand")!;
                    delegateTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Func`1")!.Construct(GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Threading.Tasks.Task")!);

                    return true;
                }

                if (methodSymbol.Parameters.Length == 1 &&
                    methodSymbol.Parameters[0] is IParameterSymbol { RefKind: RefKind.None, Type: { BaseType: null, TypeKind: not TypeKind.Pointer and not TypeKind.Pointer } } singleParameter)
                {
                    // Map <CancellationToken, Task> to IAsyncRelayCommand, AsyncRelayCommand, Func<CancellationToken, Task>
                    if (SymbolEqualityComparer.Default.Equals(singleParameter.Type, GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Threading.CancellationToken")!))
                    {
                        commandInterfaceTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.IAsyncRelayCommand")!;
                        commandClassTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.AsyncRelayCommand")!;
                        delegateTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Func`2")!.Construct(
                           GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Threading.CancellationToken")!,
                            GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Threading.Tasks.Task")!);

                        return true;
                    }

                    // Map <T, Task> to IAsyncRelayCommand<T>, AsyncRelayCommand<T>, Func<T, Task>
                    commandInterfaceTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.IAsyncRelayCommand`1")!.Construct(singleParameter.Type);
                    commandClassTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.AsyncRelayCommand`1")!.Construct(singleParameter.Type);
                    delegateTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Func`2")!.Construct(
                ...
                if (methodSymbol.Parameters.Length == 2 &&
                    methodSymbol.Parameters[0] is IParameterSymbol { RefKind: RefKind.None, Type: { BaseType: null, TypeKind: not TypeKind.Pointer and not TypeKind.Pointer } } firstParameter &&
                    methodSymbol.Parameters[1] is IParameterSymbol { RefKind: RefKind.None, Type: { BaseType : null, TypeKind: not TypeKind.Pointer and not TypeKind.Pointer } } secondParameter &&
                    SymbolEqualityComparer.Default.Equals(secondParameter.Type, GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Threading.CancellationToken")!))
                {
                    commandInterfaceTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.IAsyncRelayCommand`1")!.Construct(firstParameter.Type);
                    commandClassTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("Microsoft.Toolkit.Mvvm.Input.AsyncRelayCommand`1")!.Construct(firstParameter.Type);
                    delegateTypeSymbol = GeneratorExecutionContext.Compilation.GetTypeByMetadataName("System.Func`3")!.Construct(
                        firstParameter.Type,
