...
namespace Microsoft.Toolkit.Mvvm.Messaging
{
    ...
    public static class IMessengerExtensions
    {
        ...
        private static class MethodInfos
        {
            ...
            /// </summary>
            public static readonly MethodInfo RegisterIRecipient = null;//new Action<IMessenger, IRecipient<object>, Unit>(Register).Method.GetGenericMethodDefinition();
        }
            ...
            where TToken : IEquatable<TToken>
        {
            ...
            {
                //MethodInfo methodInfo = new[] { recipientType };
                //Type extensionsType;
                //if //(recipientType.Assembly.GetType("Microsoft.Toolkit.Mvvm.Messaging.__Internals.__IMessengerExtensions") is Type extensionsType &&
                //   (1==1)// extensionsType.GetMethod("CreateAllMessagesRegistratorWithToken", new[] { recipientType }) is MethodInfo methodInfo)
                //{
