        ...
        private async void ShowLatestAppMessage()
        {
            ...
            try
            {
                    ...
                    && message.Importance <= level)
                {
                    ...
                    MessageTimestampRun.Text = date.ToString() + " "
                        + date.ToLocalTime();
